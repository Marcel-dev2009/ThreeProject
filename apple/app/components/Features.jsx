    ...
    <div className="screen-max-width">
      ...
      <div className="flex flex-col justify-center items-center overflow-hidden">
        <div className="mt-32 mb-24 pl-24">
           <h2 className="text-5xl lg:text-7xl font-semibold">iphone</h2>  <br />
        ...
        <div className="flex-center flex-col gap-1.5 sm:px-10 ">
          ...
          <div className="flex flex-col w-full relative">
            ...
            the first iPhone to feature an aerospace-grade titanium design
             ...
             using the same alloy that spaceCrafts use for mission to Mars <a href="https://space-x-ico.vercel.app/">See SpaceX</a>
            </p>
